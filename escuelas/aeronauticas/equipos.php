    ...
    <h5 class="titulo-generico" style="font-size:40px;">Aeronaves</h5>

    
    <br>

    <b class="text-fix-style" id="grisfia">CESSNA 172S</b>
    ...
    <button class="btn text-white text-fix-style text-center" type="button" style="background-color:#E0134E;border-radius:unset;outline:none;" data-toggle="collapse" data-target="#fotosavion" aria-expanded="false" aria-controls="collapseExample">
    ver más imágenes
    </button>
    </div>
  ...
  <h5 class="titulo-generico" style="font-size:40px;">Simuladores</h5>
    ...
    <b class="text-fix-style" id="grisfia">REDBIRD FMX</b>

...
<hr>
    ...
    <h2 class="subtitle-general-fix mt-5">OBJETIVOS ACADÉMICOS</h2>
    ...
    <h2 class="subtitle-general-fix mt-5">Objetivos Específicos</h2>
    ...
    <h2 class="subtitle-general-fix">OFICINA DE ACREDITACIÓN</h2>

...
<li>Comunicación efectiva en idioma español, en forma oral y escrita.</li>
<li>Comunicación básica en idioma inglés.</li>
<li>Conocimientos de matemática: Números relacionales y funciones; Geometría y mediciones.</li>
<li>Conocimientos básicos de Historia del Perú y su interrelación con los procesos políticos, económicos y sociales, del continente americano y del mundo.</li>
<li>Capacidad de explicar las relaciones entre su desarrollo personal y su entorno social, familiar y geográfico; y actuar en función de los requerimientos de las mismas, a través del trabajo en equipo, el ejercicio de la solidaridad, el respeto mutuo, la responsabilidad social y la protección del ambiente.</li>
<li>Práctica de una vida sana, a través de la actividad física y deportiva, de la higiene personal y mantener un cuerpo saludable y un alto rendimiento de sus capacidades intelectuales.</li>
<li>Vocación por la carrera profesional que ha elegido.</li>
</ul>


<h4 class="subtitle-general-fix mt-5">
Perfil del Egresado
</h4>
<div class="row mt-2">

<div class="col-md-6">
    <b class="" style="color:#585857;font-family:Roboto Condensed">  Competencias Genéricas Cognitivas</b> 
    <ul class="fix-items-li">
    ...
    <li>Aplica adecuadamente estrategias meta-cognitivas, lo que lo capacita para el aprendizaje autónomo para toda la vida (Aprender a aprender).</li>
    </ul>
</div>

<div class="col-md-6">
    <b class="" style="color:#585857;font-family:Roboto Condensed">  Competencias Genéricas Instrumentales</b> 
    <ul class="fix-items-li">
...
<br><br>
<div style="display:flex;align-items: center;justify-content: center;mt-3">
<b style="color:#585857;font-family:Roboto Condensed">    Competencias Específicas </b> 
</div>

<b class="text-fix-style">Durante los primeros años después de su graduación, el graduado presentará las siguientes competencias (educational objectives):</b>  

<ul class="mt-4 fix-items-li">
...
<b class="text-fix-style">Para el momento de su graduación, el estudiante presentará los siguientes resultados (outcomes):
</b>  
...
<b style="color:#585857;font-family:Roboto Condensed">Actitudes y valores generales</b>  

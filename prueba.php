...
<body>
    ...
    <br>
      <div class="social-bar" >
            ...
            <a href="https://www.facebook.com/" class="icon icon-facebook2" target="_blank"> <span id="boton">&nbsp;Facebook</span></a>
            <a href="https://twitter.com/" class="icon icon-twitter" target="_blank"><span id="boton">&nbsp;Twitter</span></a>
            <a href="https://www.youtube.com/" class="icon icon-youtube" target="_blank"><span id="boton">&nbsp;YouTube</span></a>
            <a href="https://www.instagram.com/" class="icon icon-instagram" target="_blank"><span id="boton">&nbsp;Instagram</span></a>

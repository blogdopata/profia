...
<!--inicio modal beneficiarios OSG-->
<div class="modal fade" id="beneficiariosOSG" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header popupheader">
        <h5 style="color:white;" class="modal-title" id="exampleModalLabel">Oficina de Seguimiento al Graduado </h5>

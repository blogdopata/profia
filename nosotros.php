...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="Conoce más sobre nosotros. Revisa nuestros valores y principios. Somos la Facultad de Ingeniería y Arquitectura de la USMP.">
    <meta name="keywords" content="Nosotros,NOSOTROS,nosotros" />
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
   

    <!-- Title -->
    <title>Nosotros | Facultad de Ingeniería y Arquitectura (FIA) – USMP</title>
            ...
            <div class="col-12">
                ...
                <div style="margin-left:20px; ">
                    ...
                    <p class="text-fix-content">
                        ...
                        <strong> Búsqueda de la excelencia: </strong> <br> 
                        Orientación permanente hacia el mejoramiento continuo.
                    </p>    
                ...
                <h3 class="acreditacion-title mb-4">PRINCIPIOS</h3>
                    ...
                    <div style="margin-left:20px; ">
                        ...
                        <br> 
                        Búsqueda del desarrollo autosostenido e innovador en nuestros servicios y propuesta de valor.
                        </p>
                    </div>    

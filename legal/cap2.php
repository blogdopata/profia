...
<div class="container" style="border:solid grey 1px;box-shadow: 6px 6px 6px grey;">
	<div class="row text-justify" >
        ...
        <br>
            ...
            <b class="titulo-generico">Capítulo II - De la Matrícula de los alumnos ingresantes a través del 
            concurso ordinario de admisión</b>
            <br><br>
            ...
            <b>Artículo 23</b>.- De los requisitos para matricularse
            <p class="text-fix-style">

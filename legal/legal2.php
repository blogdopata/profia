...
<div class="container" style="border:solid grey 1px;box-shadow: 6px 6px 6px grey;">
	<div class="row text-justify" >
        ...
        <br>
            <h6 class="titulo-generico">Título Generales</h6> 
            <b class="titulo-generico">Capítulo II - Generalidades</b>
            <br><br>
            ...
            <div class="listafia">
                <ul class="ml-5">
                    <li>Planificar, coordinar, atender y supervisar los procedimientos de matrícula de los alumnos.</li>
                </ul>
            </div>
            <br><br>
            <b>Artículo 3</b>.- De las funciones de la Oficina de Registros Académicos.
            <br><br>

...
<div class="container" style="border:solid grey 1px;box-shadow: 6px 6px 6px grey;">
	<div class="row text-justify" >
        ...
        <!-- <p class="mt-3" style="text-transform: uppercase;">(Aprobado por Resolución Rectoral Nro. 1270-2003-CU-R-USMP de fecha 15 de octubre del 2003)</p> -->
            ...
            <b class="titulo-generico">Capítulo V - De las renuncias a la universidad</b>
            <br><br>
            <b>Artículo 62</b>.- De la renuncia a la Universidad
            ...
            <b>Artículo 63</b>.- De los requisitos
            ...
            <div class="listafia">
                ...
                <li>Solicitud valorada dirigida al Decano.</li>
                <li>Carta Notarial indicando su renuncia voluntaria</li>
                <li>Constancia de Tesorería ( no tener deudas pendientes con la Universidad)</li>
                <li>Constancia de Biblioteca</li>
                </ul>
            </div>

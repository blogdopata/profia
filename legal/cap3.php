...
<div class="container" style="border:solid grey 1px;box-shadow: 6px 6px 6px grey;">
	<div class="row text-justify" >
        ...
        <br>
            <h6 class="titulo-generico">Título I De la Matrícula</h6> 
            <b class="titulo-generico">Capítulo III - De las matrículas de los alumnos ingresantes exonerados del concurso ordinario de admisión</b>
            <br><br>

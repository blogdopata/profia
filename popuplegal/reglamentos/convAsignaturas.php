<!--inicio modal Reglamento de Convalidación de Asignaturas-->
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header popupheader">
        <h5 style="color:white;" class="modal-title" id="exampleModalLabel">Reglamento de Convalidación de Asignaturas </h5>

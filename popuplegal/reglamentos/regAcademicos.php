...
<div class="modal fade" id="miModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <h6 class="subtitle-general-fix mt-3 ">Reglamento de Registros Académicos</h6>                                          
        <p style="text-transform: uppercase;">(Aprobado por Resolución Rectoral Nro. 1270-2003-CU-R-USMP de fecha 15 de octubre del 2003)</p>     
                                      ...
                                      <a href="legal/cap3.php"><h6>Capítulo III: de las Matrículas de los Alumnos Ingresantes Exonerados del Concurso Ordinario de Admisión</h6></a>
                                      ...
                                      <a href="legal/capi4.php"><h6>Capítulo IV: Curso de Nivelación </h6></a>
                                      ...
                                      <a href="legal/capi5.php"><h6>Capítulo V: de las renuncias a la universidad</h6></a>
                                      Artículo 62.- De la renuncia a la universidad <br>
                                      Artículo 63.- De los requisitos <br><br>


                                      <a href="legal/capi6.php"><h6>Capítulo VI: de los tramites documentarios en la Oficina de Registros Académicos</h6> </a>
                                      ...
                                      Artículo 77.- De la Carta de Prácticas Preprofesionales <br>
                                      ...
                                      <a href="legal/complementarias.php"><h6>Disposiciones Complementarias</h6></a>

                                      Artículo 80.- De los casos no previstos <br> 
                                      <hr>
                                      <a href="legal/finales.php" ><h6>Disposiciones Finales</h6></a>
      </div>

  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="overflow-y: scroll;max-height:85%;">
            ...
            <br><br>
            <hr>
            <h6>PAÍSES CON LOS CUALES NO SE TIENE CONVENIO DE RECIPROCIDAD</h6>
            <br><br>
            Los requisitos para la revalidación de grados y títulos obtenidos en Universidades extranjeras con los cuales el Perú NO tiene Convenio de Reciprocidad son los siguientes:
            <br><br>
            <div class="listanumerada">
                <ul>
